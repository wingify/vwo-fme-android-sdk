...
object Constants {
    ...
    const val WINGIFY_SDK_NAME: String = "wingify-fme-android-sdk"
    ...
    const val EDGE_HOST_NAME: String = "edge.wingify.net"
    const val COLLECT_HOST_NAME: String = "collect.wingify.net"
