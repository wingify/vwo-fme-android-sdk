 ...
 */
package com.wingify.models.impression
 ...
 * as a batch via [ImpressionPayload] to record which
 ...
 *                       Must be a positive integer when valid; 0 indicates an invalid/unset state.
 *
 * @see ImpressionPayload for collecting multiple impressions
 * @see com.wingify.utils.ImpressionUtil for operations on impressions
 */
