 ...
 */
package com.wingify.packages.logger.core

import com.wingify.ServiceContainer
import com.wingify.enums.DebuggerCategoryEnum
import com.wingify.interfaces.logger.ILogManager
import com.wingify.interfaces.logger.LogTransport
import com.wingify.packages.logger.Logger
import com.vwo.packages.logger.enums.LogLevelEnum
import com.wingify.packages.logger.transports.LogcatTransport
import com.wingify.services.LoggerService.Companion.errorMessages
import com.wingify.utils.LogMessageUtil.buildMessage
...
class LogManager(override val config: Map<String, Any>, val serviceContainer: ServiceContainer) :
    ...
    private fun handleTransports() {
        ...
        if (!transportList.isNullOrEmpty()) {
            ...
            val defaultTransport = LogcatTransport(level, serviceContainer.getInitOptions())
    ...
    override fun errorLog(
        ...
        if (shouldSendToVWO) {
            ...
            debugEventProps["lt"] = com.wingify.enums.LogLevelEnum.ERROR.name
