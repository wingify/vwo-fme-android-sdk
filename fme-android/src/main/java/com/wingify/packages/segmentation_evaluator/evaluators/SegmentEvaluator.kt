 ...
 */
package com.wingify.packages.segmentation_evaluator.evaluators
...
import com.wingify.packages.segmentation_evaluator.utils.SegmentUtil
...
import com.wingify.utils.DeviceInfo
import com.wingify.utils.JsonNode
import com.wingify.utils.asText
import com.wingify.utils.fieldNames
import com.wingify.utils.get
import com.wingify.utils.isArray
import com.wingify.utils.isTextual
import com.wingify.utils.iterator
import com.wingify.utils.size
...
class SegmentEvaluator(val serviceContainer: ServiceContainer) {
    var context: WingifyUserContext? = null
    ...
    fun checkInUserStorage(
        ...
        try {
            val storageMapAsString: String =
                WingifyClient.objectMapper.writeValueAsString(storedDataMap ?: emptyMap<String, Any>())
