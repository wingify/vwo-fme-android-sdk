...
import com.wingify.packages.segmentation_evaluator.enums.SegmentOperandRegexEnum
...
class SegmentOperandEvaluator(val serviceContainer: ServiceContainer) {
     ...
     */
    fun evaluateUserAgentDSL(dslOperandValue: String, context: WingifyUserContext?): Boolean {
