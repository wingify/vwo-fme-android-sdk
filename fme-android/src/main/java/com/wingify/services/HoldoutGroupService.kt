...
import com.wingify.constants.Constants.Holdouts.VARIATION_IS_PART_OF_HOLDOUT
import com.wingify.constants.Constants.Holdouts.VARIATION_NOT_PART_OF_HOLDOUT
...
class HoldoutGroupService(
    ...
    private fun getLocalStorageDataForThisFeature(
        ...
        return WingifyClient.objectMapper.readValue(
