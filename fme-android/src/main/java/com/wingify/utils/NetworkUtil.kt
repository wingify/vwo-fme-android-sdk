...
import com.wingify.constants.Constants.PRODUCT_NAME
import com.wingify.constants.Constants.VWO_FS_ENVIRONMENT
import com.wingify.enums.EventEnum
import com.wingify.interfaces.networking.HttpMethods
import com.wingify.enums.HeadersEnum
import com.wingify.enums.UrlEnum
import com.wingify.models.Settings
import com.wingify.models.request.Event
import com.wingify.models.request.EventArchData
import com.wingify.models.request.EventArchPayload
import com.wingify.models.request.EventArchQueryParams.RequestQueryParams
import com.wingify.models.request.EventArchQueryParams.SettingsQueryParams
import com.wingify.models.request.Props
import com.wingify.models.request.visitor.Visitor
    ...
    companion object {
        ...
        fun sendPostApiRequest(
            ...
            try {
                ...
                serviceContainer.getLoggerService()?.log(
                    ...
                    object : HashMap<String?, String?>() {
                        init {
                            put("method", HttpMethods.POST.value)
        ...
        fun sendGatewayEvent(
            ...
            try {
                ...
                val request = RequestModel(
                    url = serviceContainer.resolveHost(HttpMethods.POST),
