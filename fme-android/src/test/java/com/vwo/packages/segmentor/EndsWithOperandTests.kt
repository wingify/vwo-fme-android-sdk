...
class EndsWithOperandTests {
    ...
    fun initialize() {
        ...
        VWO.init(vwoInitOptions, object : IVwoInitCallback {
            override fun vwoInitSuccess(vwo: VWO, message: String) {
                this@EndsWithOperandTests.vwo = vwo
            }
    ...
    fun stringifiedFloatTest2() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"wildcard(*123.0)\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 7657123)
                put("expectation", true)
    ...
    fun stringifiedFloatTest3() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"wildcard(*123.4560000)\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 98765123.456)
                put("expectation", true)
