...
class EqualityOperandTests {
    ...
    @Test
    fun exactMatchTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"something\"}}]}"
    ...
    @Test
    fun trimValueTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"  hi  \"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", "          hi          ")
                put("expectation", true)
    ...
    fun numericDataTypeTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"123\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 123)
                put("expectation", true)
    ...
    fun floatDataTypeTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"123.456\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 123.456)
                put("expectation", true)
    ...
    fun stringifiedFloatTest2() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"123.0\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 123)
                put("expectation", true)
    ...
    fun stringifiedFloatTest3() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"123.4560000\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 123.456)
                put("expectation", true)
    ...
    fun charDataTypeTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"E\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
    ...
    fun booleanDataTypeTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"true\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", true)
                put("expectation", true)
    ...
    fun booleanDataTypeTest2() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"false\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", false)
                put("expectation", true)
    ...
    @Test
    fun partOfTextTest() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"zzsomethingzz\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", "something")
                put("expectation", false)
