...
class GreaterThanEqualToOperatorTests {
    ...
    fun initialize() {
        ...
        VWO.init(vwoInitOptions, object : IVwoInitCallback {
            override fun vwoInitSuccess(vwo: VWO, message: String) {
                this@GreaterThanEqualToOperatorTests.vwo = vwo
            }
    ...
    @Test
    fun greaterThanEqualToOperatorPass() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}"
    ...
    @Test
    fun greaterThanEqualToOperatorEqualValuePass() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 150)
    ...
    @Test
    fun greaterThanEqualToOperatorFail() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", 100)
    ...
    @Test
    fun greaterThanEqualToOperatorStringValueFail() {
        val dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}"
        val customVariables: Map<String?, Any?> = object : HashMap<String?, Any?>() {
            init {
                put("eq", "abc")
