...
class StorageTest : Connector() {
     ...
     * - "experimentKey": The experiment key for the data.
    ...
    override fun set(data: Map<String, Any>) {
        ...
        storage[key] = value
        println("Storage saved data = $key data provided=$data values=$value")
    }
    ...
    override fun get(featureKey: String?, userId: String?): Any? {
        ...
        println("Storage contains key=$key, value = ${storage.containsKey(key)}")
